<footer class="footer">
    <div class="container">
        <div class="footer-inner">
            <div class="row">
                <div class="col-md-6">
                    © 2016 <a href="#"></a>, All rights reserved.
                </div>
                <div class="col-md-6">
...
<script src="<?php print base_url() ?>assets/js/nprogress.js"></script>
<script src="<?php print base_url() ?>assets/js/nyimak.min.js"></script>
